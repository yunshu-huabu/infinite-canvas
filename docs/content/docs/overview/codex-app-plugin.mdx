...
```text
Install the Infinite Canvas Codex plugin from https://github.com/yunshu-huabu/infinite-canvas.git.
...
```bash
mkdir -p ~/plugins
git clone https://github.com/yunshu-huabu/infinite-canvas.git ~/plugins/infinite-canvas
