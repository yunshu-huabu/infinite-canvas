...
See [SECURITY.md](https://github.com/yunshu-huabu/infinite-canvas/blob/main/SECURITY.md). Do not post exploit details, private API keys, sensitive screenshots, or real user data in a public issue.
